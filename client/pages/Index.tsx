    ...
    return properties.filter((property) => {
      ...
      if (searchQuery) {
        ...
        const searchableText =
          `${property.title} ${property.description} ${property.location.address} ${property.location.city} ${property.location.state} ${property.features.propertyType}`.toLowerCase();
      ...
      if (
        ...
        property.features.propertyType !== filters.propertyType
      ) {
        return false;
      }
        ...
        <div className="relative container mx-auto px-4 py-24">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-lg mb-8 max-w-2xl mx-auto text-luxury-200">
              Step into your dream home with immersive VR tours. Browse premium
              real estate with cutting-edge virtual reality technology.
            </p>

            {/* Stats */}
            <div className="flex flex-wrap justify-center gap-8 mb-8">
              <div className="text-center">
                <div className="text-3xl font-bold text-luxury-300">
                  {properties.length}
                </div>
                <div className="text-sm text-luxury-200">
                  Premium Properties
                </div>
              </div>
              <div className="text-center">
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold text-gray-900 mb-4">
              Why Choose VR Estate
            </h2>
            <p className="text-gray-600 max-w-2xl mx-auto">
              Revolutionary real estate experience combining traditional
              property viewing with immersive virtual reality technology.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Walk through properties from anywhere in the world with 360°
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Curated selection of luxury homes, condos, and commercial
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">
                Work with experienced real estate professionals who understand
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 max-w-2xl mx-auto">
              Explore our curated collection of premium real estate with
              advanced filtering and immersive VR tours.
            </p>
          </div>
          ...
          <div>
            <div className="flex items-center justify-between mb-8">
              ...
              <div className="flex items-center gap-2 text-sm text-gray-600">
                ...
                <span>
                  {filteredProperties.filter((p) => p.vrTour.available).length}{" "}
                  with VR Tours
                </span>
              </div>
            </div>
      ...
      <section className="py-16 bg-primary text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg mb-8 text-primary-foreground/80 max-w-2xl mx-auto">
            Schedule a private VR tour or speak with one of our expert real
            estate agents today.
          </p>
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Button
